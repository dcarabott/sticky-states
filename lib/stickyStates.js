...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "ui-router-core"], factory);
    }
    ...
    var StickyStatesPlugin = (function (_super) {
        ...
        StickyStatesPlugin.prototype._defineStickyEvents = function () {
            ...
            this.pluginAPI._defineEvent("onInactivate", ui_router_core_1.TransitionHookPhase.ASYNC, 5, paths.inactivating, true);
            this.pluginAPI._defineEvent("onReactivate", ui_router_core_1.TransitionHookPhase.ASYNC, 35, paths.reactivating);
        };
    ...
    }(ui_router_core_1.UIRouterPluginBase));
